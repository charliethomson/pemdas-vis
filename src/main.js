...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    Closure_fromTearOff: function(receiver, functions, applyTrampolineIndex, reflectionInfo, isStatic, isIntercepted, propertyName) {
      var $prototype, $constructor, t1, trampoline, signatureFunction, applyTrampoline, i, stub, stubCallName, _null = null,
    ...
    _functionRtiToString: function(rti, genericContext) {
      var boundsRti, outerContextLength, offset, i, i0, typeParameters, typeSep, t1, t2, boundRti, returnTypeText, argumentsText, sep, argument, optionalArguments, namedArguments, _s2_ = ", ";
  ...
  P = {_TimerImpl: function _TimerImpl() {
    ...
    StringBuffer__writeAll: function(string, objects, separator) {
      var iterator = (objects && C.JSArray_methods).get$iterator(objects);
      if (!H.boolConversionCheck(iterator.moveNext$0()))
        return string;
      if (H.boolConversionCheck(J.get$isEmpty$s(separator))) {
        do
    ...
    IndexError$: function(invalidValue, indexable, $name, message, $length) {
      ...
      return new P.IndexError(t1, invalidValue, $name, message != null ? message : "Index out of range");
    },
  ...
  A = {LexerToken: function LexerToken() {
    }, Lexer: function Lexer() {
    }, TokenTree: function TokenTree() {
    }},
  B = {
    Node$: function() {
      var t1 = new B.Node();
    ...
    node_test: function() {
      var a = B.Node$(),
        l = B.Node$(),
        r = B.Node$();
      a.renderHtml$3("#node-canvas", H.setRuntimeTypeInfo([], [P.num]), 0);
      a.left = l;
      a.right = r;
      return H.boolConversionCheck(a.get$hasLeft()) && H.boolConversionCheck(a.get$hasRight());
    },
    Node: function Node() {
  ...
  F = {
    tests: function() {
      if (H.boolConversionCheck(B.node_test()))
        P.print("node tests: passed");
      else
        H.throwExpression("node tests: failed");
    },
    main: function() {
      F.tests();
    }
  };
  var holders = [C, H, J, P, W, A, B, F];
  ...
  W.CanvasRenderingContext2D.prototype = {
    ellipse$8: function(receiver, x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise) {
      return receiver.ellipse(H.numTypeCheck(x), H.numTypeCheck(y), H.numTypeCheck(radiusX), H.numTypeCheck(radiusY), H.numTypeCheck(rotation), H.numTypeCheck(startAngle), H.numTypeCheck(endAngle), H.boolTypeCheck(anticlockwise));
    },
  ...
  W.InputElementBase.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.HiddenInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.TextInputElementBase.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.SearchInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.TextInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.UrlInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.TelephoneInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.EmailInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.PasswordInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isTextInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.RangeInputElementBase.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.DateInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.MonthInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.WeekInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.TimeInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.LocalDateTimeInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.NumberInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.RangeInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isRangeInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.CheckboxInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.RadioButtonInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.FileUploadInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.SubmitButtonInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.ImageButtonInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.ResetButtonInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  W.ButtonInputElement.prototype = {$isInterceptor: 1, $isChildNode: 1, $isElement: 1, $isEventTarget: 1, $isGlobalEventHandlers: 1, $isInputElementBase: 1, $isNode0: 1, $isNonDocumentTypeChildNode: 1, $isParentNode: 1};
  ...
  A.LexerToken.prototype = {};
  A.Lexer.prototype = {};
  A.TokenTree.prototype = {};
  B.Node.prototype = {
    Node$0: function() {
      this.right = this.left = null;
    },
    get$hasLeft: function() {
      return this.left != null;
    },
    get$hasRight: function() {
      return this.right != null;
    },
    renderHtml$3: function(canvasid, parentXY, depth) {
      var canvas, ctx;
      H.stringTypeCheck(canvasid);
      H.assertSubtype(parentXY, "$isList", [P.num], "$asList");
      H.intTypeCheck(depth);
      canvas = H.interceptedTypeCheck(W.querySelector(canvasid), "$isCanvasElement");
      ctx = (canvas && C.CanvasElement_methods).get$context2D(canvas);
      P.print(ctx.fillStyle);
      ctx.fillStyle = "#FF0000";
      P.print(ctx.fillStyle);
      (ctx && C.CanvasRenderingContext2D_methods).ellipse$8(ctx, 200, 200, 200, 100, 0, 0, 0, false);
      P.print(H.S(canvas) + ", " + H.S(ctx));
    }
  };
  B.Value.prototype = {};
  B.Operator.prototype = {};
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(H.Closure, [H.Instantiation, H.Closure_fromTearOff_closure, H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1]);
    ...
    _inheritMany(W.Node0, [W.Element, W.CharacterData, W.Document, W.DocumentFragment, W._Attr, W._DocumentType]);
    ...
    _inheritMany(B.Node, [B.Value, B.Operator]);
  })();
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
